...
const trustItems = [
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--ds-dim)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div style={{ background: CREAM, minHeight: '100vh' }}>
      ...
      <section className="px-6 sm:px-10 lg:px-16 pt-16 sm:pt-20 pb-12 sm:pb-14" style={{ background: CREAM }}>
        <div style={{ maxWidth: 600 }}>
          ...
          <h1 style={{ fontFamily: D, fontWeight: 700, fontSize: 'clamp(2.6rem, 6vw, 4.5rem)', lineHeight: 1.05, color: TEXT, margin: '0 0 20px', letterSpacing: '-0.02em' }}>
      ...
      <section className="px-6 sm:px-10 lg:px-16 pb-24" style={{ background: CREAM }}>
        <div className="max-w-5xl mx-auto grid lg:grid-cols-5 gap-10 items-start">
          ...
          {/* Form card */}
          <div className="lg:col-span-3" style={{ background: LINEN, borderRadius: 20, border: `1px solid ${HAIRLINE}`, padding: '36px 32px' }}>
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            {/* Trust signals */}
            <div style={{ background: LINEN, borderRadius: 20, border: `1px solid ${HAIRLINE}`, padding: '28px 24px' }}>
            ...
            {/* Quote */}
            <div style={{ background: NAVY, borderRadius: 20, padding: '28px 24px' }}>
            ...
            <p style={{ fontFamily: B, fontSize: '0.88rem', color: TEXT2, textAlign: 'center', margin: 0 }}>
              Prefer email?{' '}
              <a href="mailto:parentcoachwithmarissa@gmail.com" style={{ color: 'var(--ds-text-2)', fontWeight: 600, textDecoration: 'underline' }}>
