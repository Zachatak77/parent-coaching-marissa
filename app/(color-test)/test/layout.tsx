    ...
    >
      <nav className="max-w-6xl mx-auto flex h-16 items-center justify-between px-6 sm:px-10 lg:px-16">
        <Link href="/test" className="flex items-center flex-shrink-0">
          <div>
            <span style={{ display: 'block', fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: '0.85rem', letterSpacing: '.22em', textTransform: 'uppercase', color: BLUE, lineHeight: 1, marginBottom: 1 }}>Reimagine</span>
            <span style={{ display: 'block', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1.25rem', color: TEXT, lineHeight: 1 }}>Parenting</span>
          </div>
        </Link>
