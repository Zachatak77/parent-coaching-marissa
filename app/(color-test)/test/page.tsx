  ...
  return (
    <div style={{ background: CREAM }}>
      <style>{`
        ...
        .rp-marquee-track { animation: rp-marquee 36s linear infinite; }
        .rp-blob-1 { animation: rp-drift 14s ease-in-out infinite; }
        .rp-blob-2 { animation: rp-drift-2 18s ease-in-out infinite; }
        @media (prefers-reduced-motion: reduce) {
          .rp-marquee-track, .rp-blob-1, .rp-blob-2 { animation: none; }
        }
      `}</style>
      ...
      <section aria-labelledby="hero-heading" className="relative overflow-hidden" style={{ background: '#FFFFFF' }}>
        ...
        <div className="relative mx-auto max-w-6xl px-6 sm:px-10 lg:px-16 pt-16 pb-20 sm:pt-24 sm:pb-28 lg:pt-28 lg:pb-32">
          <div className="grid items-center gap-14 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div>
              <Reveal>
                <Eyebrow>Parent coaching · Neurodiverse kids 3–12</Eyebrow>
              </Reveal>
              <Reveal delay={80}>
                <h1
                  id="hero-heading"
                  style={{ fontFamily: D, fontWeight: 700, fontSize: 'clamp(2.8rem, 6.5vw, 4.8rem)', lineHeight: 1.02, letterSpacing: '-0.025em', color: TEXT, margin: '22px 0 24px' }}
                >
        ...
        <div className="mx-auto max-w-6xl">
          <Reveal>
            <div className="mb-14 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
              ...
              <Link href="/services" className="group inline-flex items-center gap-2 self-start sm:self-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5F728D] rounded-sm"
                style={{ fontFamily: U, fontWeight: 600, fontSize: '0.78rem', letterSpacing: '.14em', textTransform: 'uppercase', color: NAVY, textDecoration: 'none' }}>
                All services <span aria-hidden className="transition-transform duration-300 group-hover:translate-x-1">→</span>
              </Link>
            </div>
          </Reveal>
          <div className="grid gap-6 sm:grid-cols-3">
            {services.map(({ title, best, body }, i) => (
              <Reveal key={title} delay={i * 120}>
                <article className="group flex h-full flex-col rounded-2xl border p-8 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl" style={{ borderColor: 'rgba(0,0,0,0.08)', background: CREAM }}>
                  ...
                  <Link href="/services" className="inline-flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5F728D] rounded-sm"
                    style={{ fontFamily: U, fontWeight: 600, fontSize: '0.74rem', letterSpacing: '.14em', textTransform: 'uppercase', color: TEXT, textDecoration: 'none' }}>
      ...
      <section aria-labelledby="about-heading" className="px-6 sm:px-10 lg:px-16 py-20 sm:py-28" style={{ background: '#FFFFFF' }}>
        <div className="mx-auto grid max-w-5xl items-center gap-12 lg:grid-cols-[0.4fr_0.6fr]">
          <Reveal>
            <div aria-hidden className="relative mx-auto flex h-64 w-64 items-center justify-center sm:h-72 sm:w-72">
              <div className="absolute inset-0 rounded-full opacity-30 blur-2xl" style={{ background: `radial-gradient(circle, ${NAVY}, transparent 70%)` }} />
              <div className="relative flex h-full w-full items-center justify-center rounded-full border" style={{ background: CREAM, borderColor: 'rgba(0,0,0,0.07)' }}>
                <span style={{ fontFamily: D, fontWeight: 700, fontSize: '5rem', color: NAVY }}>M</span>
              </div>
              <span className="absolute -right-1 bottom-6 rounded-full px-4 py-1.5 shadow-md" style={{ background: INK2, fontFamily: U, fontWeight: 600, fontSize: '0.66rem', letterSpacing: '.14em', textTransform: 'uppercase', color: '#fff' }}>
                10+ yrs in sped
              </span>
            </div>
          </Reveal>
          <Reveal delay={120}>
            <div>
              ...
              <Link href="/about" className="group inline-flex items-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5F728D] rounded-sm"
                style={{ fontFamily: U, fontWeight: 600, fontSize: '0.78rem', letterSpacing: '.14em', textTransform: 'uppercase', color: NAVY, textDecoration: 'none' }}>
                Meet Marissa <span aria-hidden className="transition-transform duration-300 group-hover:translate-x-1">→</span>
              </Link>
            </div>
          </Reveal>
        </div>
