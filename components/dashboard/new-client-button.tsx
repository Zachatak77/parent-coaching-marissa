          ...
          {loginLink ? (
            <>
              ...
              <DialogFooter className="pt-2">
                <Button className="bg-[#5F728D] hover:bg-[#54647C]/90 text-white" onClick={handleClose}>
                  Done
                </Button>
              </DialogFooter>
            </>
            ...
            <>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 mt-2">
                ...
                <DialogFooter className="gap-2 pt-2">
                  ...
                  <Button type="submit" className="bg-[#5F728D] hover:bg-[#54647C]/90 text-white" disabled={loading}>
